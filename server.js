...
app.post("/push", async (req, res) => {
  ...
  const payload = {
    ...
    ticket: { ticketPerPerson: true, ticketMsg: "Please present this ticket at the meeting point." },
    ...
    rates: { defaultRate: { id: 2364854 }, rates: [{ pricingCategoryIds: [1153185, 1153187], pricedPerPerson: true, allPricingCategories: false }] },
    availabilityRules: [{ recurrenceRule: {}, allStartTimes: true, maxCapacity: capacity }]
  };
  try {
...
app.post("/push-reseller", async (req, res) => {
  ...
  for (const product of products) {
    const payload = {
      ...
      duration: { weeks: 0, days: 0, hours: 1, minutes: 0 },
    ...
    bookingType: "DATE_AND_TIME",
      ...
      availabilityRules: [{ recurrenceRule: {}, allStartTimes: true, maxCapacity: 10 }],
