...
app.post("/push", async (req, res) => {
  ...
  const payload = {
    ...
    inventorySettings: { capacityType: "LIMITED", unlimitedCapacity: false, capacity: capacity },
...
app.post("/push-reseller", async (req, res) => {
  ...
  for (const product of products) {
    const payload = {
      ...
      bookingType: "DATE_AND_TIME",
      inventorySettings: { capacityType: "LIMITED", unlimitedCapacity: false, capacity: 10 },
